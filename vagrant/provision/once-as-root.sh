...
mysql -uroot <<< "CREATE DATABASE db_dilg_arta_rris"
mysql -uroot <<< "CREATE DATABASE db_dilg_arta_rris_test"
mysql -uroot <<< "create user 'root'@'10.0.2.2'; grant all privileges on *.* to 'root'@'10.0.2.2'; flush privileges;"
